...
It's 1630 on 6 June 1944, Captain Foreman just arrived at his company 
harbour near Colleville.  An hour earlier, he and the 11 lorries of C Platoon
90 Company RASC disembarked the LSTs they have been stuck on for the past six
days waiting to cross the English Channel to support Operation Overlord, the
Anglo-American invasion of Normandy France.  Loaded in these 11 lorries are
supplies for 6 Airborne Division currently operating to secure the British 
left flank over the Orne.  These loads consist of `pet[rol], [ammunition], 
R[oyal] E[ngineer] stores, and water', stores vital for the paras of 6 Airborne
Division to resist a German counter attack. %cite Jun hist rep 4
...
% how do I make this transition?
	...
	% Segue to historiographical review?  Zoom out and just break the 
	% forth wall.
