...
testing a citation.\autocite[beginning][end]{pri-testcite}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Stop Work Point 23 1954 Jul 25
%
% Started writing the intro and am fleshing out historiography.  Trying to 
% figure out biblatex-chicago syntax for primary sources.  Check unpublished
% type.  Tried unpublished type, will crosscheck later with CMOS.  Might have
% to use misc
%
% This is going to take a while, must corssreference TNA, DND, LAC, and CMOS
