...
jerrycan (a German petrol can).  Moreover, by Overlord, jerricans were 
...
was ordered to mount up ontop of the jerries and they were rushed East.  After
...
\section{The Arrivals of A \& B Plns (14 -- 23 June)}
...
completed, both B and C platoons of 90 Coy spend the 14th of June maintianing 
their viehicles and, doubtless, getting some rest at Coy HQ located in a field,
some 500 m NW of Cresserons.  Here and there, the Coy
do some minor transport details --- delivering rations, ammunition, fuel, the
usual minutae of war --- but the situation is quiet.  The next few days are 
fairly quiet for teh Brigade.  Most of its forces are in defencive positions 
...
German strong pionts or repelling small attacks but nothing that, from a 
logistical standpoitn, couldn't be managed through the usual supply runs.

Back in England, A, and the part of B platoon 90 Coy RASC that did not land on 
D-Day are now mounting their lorries and embaring on LSTs for a their channel 
crossing.  The 59 vehicles and 165 personnel of this platoon groop arrives 
and begins disembarking at Queen Beach around 2000 hrs on the 15th.  Three 
hours later, they make the 6-7 km journy to Cresserons to join the rest of
...
the location of latreens, mess arragements, and the usual qustions one asks 
living in the field; however, the sporadic bombing likely helped to emphisze
...
Withe the new intake of vehicles and men, teh Coy spend the next few days
reorganizing and dewaterproofing their new vehicles and doubltlessly, handling
routine supply runs, all whilst being sporadically shelled.  Beyond slit 
trenches ther was little to be done beyond spread out the vehicles with 75 yds
bewteen them to minimize teh damage of a single bomb or shell.  One must wonder
what a dreadful inconvinience this must have been to have to go possibly
...
shelling.  This harrassing fire must have been irritating as the Germans did 
not do very much heavy shelling.  Instead, using 17 June as an example, the
Geramns would lob a few shells (six in this case) over the course of a day and 
hope they hit something.  One wonders if slit trenches were dug at every vehicle
or if you hear the whilstle of an incomming shell, if you just lie down and 
pray.  It is likely that sleeping positions were in slit treches but even a 
trench was not always enough to protect the men.  Every few days, a few men 
would be evacuated with wounts from shelling.
...
ocean, these modifications had to be removed beofre the vehicles drove too 
many miles as tehy prevented the proper cooling of their engines.  
...
brief stabalization in 27 Armd Bde's AO, one begins to see a return to the
...
`Attention will be paid not only to properly constitutded latrine erections but
...
road, and to turn on the corect side.\autocite[June Adm Order No. 1][Para 9]
...
Beyond these more humourous examples however, these Admin Os reveal a 
situation of scarsity.  For a start, in the Brigade area, there were only
...
feed, multiply by the number of meals between supply runs, devide by the number
...
Available stores will be delivered next day'.\autocite[June Admn Order No. 1]
[Para 6a]{27wd}  This thus creates an elastic demand on 90 Coy where any day
could have more or fewer stores thus complicating calcuations.  

The first week of Overlord also saw some real shrotages.  Almost all vehicles
...
Order No. 1 (June)]{27wd} What's worse was drivers had a habit of runing
...
usually rely on being well enoguh connected to the supply chain that they 
...
were to return the stove to the Brigade Ordnance Offier so that the stove
...
% commanders burdens
When well run, a comamnder, and thus, the author of most of our soruces need
...
dehydrate.  Put yoruself in the hobnailed ammo boots of a supply officer and
you recieved that order on redistributing cookers.  

All of these requirements would have to be foreseen and 
prepaired well in advance to ensure the required stores were available when
needed.  This is when the army was simply in stais; however, by the end of
...
This salient was anchored by two Chateux, Chateau de la Londe, and Chateau de
...
As ever, 90 Coy's tasking was principly to support the armoured units; however,
their first job of the operation was to deliver some 30 lorry loads of 105 mm
ammunition to the gunlines several kilometers away from the front lines South
of a commune named Plumetot.  Here, several Gun Batteries of the Royal Artillery
were emplaced in prepairation for the upcomming battle. 
...
the British ARmy was liable to attempt to crush that obsticle under the weight
...
could be a preplanned supressive bombardment such as a creeping barrage where 
...
troops massing, likely in prepairation for a counter attack.  Thus, Lt Boyle 
...
saturated the target area.\autocite[133]{gunfire}  It is this abiliy to 
rapildly concentrate firepower on any point within range of the batteries
...
multi-day preparitory bombardments to entirely destroy enemy positions.  
These bombardments were too wasteful of ammunition, destroyed the ground, and
were not terribly effecive at destroying an entrenched enemy.  
...
happy to kill them but the usual aim was to supress them.  

Despite these ammunition saving measures however, to do this required a vast 
expediture of amunition.  It was assumed that for a unit with
...
enormus.  In the leadup to Operation Goodwood, which we will discuss later,
...
On humanitarian grounds, high casulaties are not desireable; however, on 
strategic grounds, this would have been disasterous.  Unlike the US or
even the Canadians, by 1944, the British were running short on men.  The 
British were unable to replace casualties from drafting more troops from 
home.  The manpower nolonger existed.  The British could not be wasteful 
...
daring to concerve manpower.  This was with ready access to ammunition and
firepower.  Without regular supplies of ammunition to the guns, it is 
difficult to imagine the British Army would be able to maintain lower
casulaties, but it is difficult to see how the British Army would have
been able to fight with higher.  %e find a better way to conclude this sub


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Stop Work Point 9 1635 Sep 25
%
% Added arty section
%
