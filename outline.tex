...
a further 25 miles instantly available for use.\autocite[Precis of Lecture
No. 12:  Petrol][s 3]{27course}
...
meets it's piece handing functions.
...
{For reference, the 2025 Toyota Corolla has a % number
litre tank.}%cite
...
Nevertheless, despite their questionable durability, the British Army had some
sound reasons for using containerized rahter than bulk distribution.  Firstly,
tanker lorries weren't nearly so common in 1940 as the are today.  Secondly,
...
%
% Flesh out fuel a little more, then link to 90 coy and draw emphisis to how
% supply chain adapted to combat realities.  Tie to why critical for war.
% expnd with where 90 coy fits in and the reality of Overlord and these 
% demarcations.
%
