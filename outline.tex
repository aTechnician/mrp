...
available.  What would have then likely happened was that he would calculate 
...
through reams of paperwork trying to locate a single line item but, until 
...
Thus, when the ammunition was finally located on the afternoon of D + 3, the
...
with repelling a German attack.  The German attack was successfully repulsed
...
that which is needed is obtained. 
%e this is kinda messy. is there a better way?
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Stop Work Point 30 2005 Jul 25
%
% Talk about the fires that were happening due to attack to reinforce point 
% prepariation in lgoistics is key, even if they aren't really killing anyone
% per se
%
