...
\section{Introduction}
	...
	% Shift to that historiographical frame:  With the benifit of 
...
% of conferences occur in prepariation for goodwood.  Viehicles are likely
% being maintained and losses replenished in this time.  2nd Army's being
% reoganized and a CO's conference on battle lessons occurs on the 13th.
%cite 27th WD
...
% to ops.  No food, no amn, no POL, no fighting. (goodwood's detailed)
% Argue that trucks, not jsut tanks are what it means for an army to be mobile.

% STRUCTURE:  go day by day in the runup and keep very chrono-narrative.  
% each day seems to sort nicely into themes; thus, use thsoe themes and
% talk about them

% Point of operation  How do i want to manage thsi transition?  This is
% too abrupt

% THEME FOR 14TH:  Battle sustainment
% WngO (formal or informal) likely recieved for Goodwood 14th late morning or
% early afternoon.  90 Coy spends the afternoon organizing, then
% 14 Jul, over five hours (1700-2200), 90 Coy 
% converts teh 13/18 rgmt amn & POL dumps IVO Ranville into dumps fit to 
...
% POL:  18 lorryloads of Pet & Derv (diesil) (7000 (either units or gal) of
% each).  This is enough POL to take the Bde 30 mi.  Coy does this via the BAD
% and PD.  Vehs fueled as well before return to Coy HQ by 2400.  SPeculate this
% was in reciept of WngO On 15th at 1900, Coy formally 
% establishes a det at the Ranville dumps to control R&I.  Det consists of 
% Capt Duffus, 46 ORs and 16 lorries.  Useful time to talk about fightiing
% range and what it means.
%cite 90 Coy WD

% By the 15th, prepairations for Goodwood occur in ernest across the Bde.  
% 3 Div holds another confernece and, over the next few days, the Bde starts
% mvoing E of Orne likely via Ranville.  %cite 27th WD 15th Jul-ish
...
% Useful tme to talk about importance of flexibility maybe?  
%cite 90 coy WD

% 16th:  RATIONS
% Bde HQ moves closer to Raanville but stays W of Orne.  Bde Cmd holds 
...
% LIkely, whilst not stated in teh WD, that 90 Coy made these regular 
...
% left flank as 8 Corps breaks through.  Bde estabishes it's battle net today.
%cite 27th WD and Orders
% 90 Coy recieves two wireless lorries, one at Coy HQ, and 1 at the Ranville
% det.  Each lorry comes with 3 wireless ops.  %cite 90th WD
% Curiusly, the OpO hardly mentions logistics.  Log is just expected to work.
...
% ditto 20th.  Little chang ehappens at this point as the front stabilizes.
%cite 27th WD
% 90 Coy uses this as a time to resuppy units from Det Ranville.  
% talk about how amunition moves.  The Ranville dump goes from X lorry 
% loads to 45 loads of amn when the dump closes and teh amn is brought back
...
% 2nd Army's 22 Transprot Coln at months end.  
% Det Ranville shrinks by 45 lorry loads of amn
% and the coy moves to Camilly (GR 933704).  Det Ranville is hadned over to 
...
\section{} %nto sure what to call it, something about being an ordinary
% 2nd line RASC unit
...
% Discuss my gaps, I barely touch on maintenence units, etc.  What I could
...
% talk about how enteries like 6 Jun are very long --- likely because of the
% initial excitement.  THe WD's progressively shorter and more concise as time
% wares on, likely because it's teadious and, "I want to go to bed!".  Supply
% logs are tedious.  Talk about how this study is actually quite constrained
% by sources in so far as a heavy dependace on electronic sources.  War diaries
% don't mention routine replenishments but it doesn't mean they don't happen.
% alas, I doubt they kept the waybills!

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Stop Work Point 19 2000 Jul 25
%
% Prepairing to talk about what happens to the company after the 27th is 
% disbanded.  Starting work on Aguust diary.  Talk till end of Aug to show
% other side of log.
%
% Working note, fleshing out the analisys more
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
