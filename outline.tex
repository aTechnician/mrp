...
\section{Introduction}
	...
	% Transition into Historiographical Review by discussing how current
	% attention is primarily paid to the ifghting services.
...
\section{British Modus Operandi}
	...
	% Start with the fighting troops cause that's what everyone knows,
	% then breifly describe everything that goes into ensuring they
	% can actually fight.  Go into concepts like tooth to tail.
	% I feel like this should be in the introduction or maybe this is a 
	% good way to talk about historiography before tying up our knowledge
	% at the end.

	% how an army actually works.  Maybe do a high-level explainer of 
	% this?  Is it not obvious though?  I suppose not, else we wouldn't 
	% just talk about cbt arms whilst sparing no thought for the services.

	% Q, A, and G branches.  How they interact and how they work in the 
	% field.
		% Why paperwork matters despite the scorn it gets?	

			% Administration, how do you ensure you get what
			% you need on time?

			% Who tells the family if someone gets killed and
			% who sends forward replacements to make up losses?
		
			% How do you get paid on time?  How do you fight a
			% war if you can't sort this stuff out?
	...
	% Is it worth citing more of FSR?
...
% whatnot too.   Yes, it is non-critical but useful to give context
