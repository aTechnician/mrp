...
advance as far forward as planned, the supply dumps taht were to be set up all
...
into an effective supply chain however much improvised.  It should be 
noted that, at it's core
...
the Base Sub-Area(BSA), the Line of Communication Area (LoC),
the Corps or GHQ Area, and finally, the Divisional Area.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Stop Work Point 26 0208 Jul 25
%
