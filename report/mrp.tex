...
were not terribly effective at destroying an entrenched enemy.%cite  
...
happy to kill them but the usual aim was to suppress them.%cite
...
suffice to mimimize the potential for losses.  %e I hate this...
...
information to ensure Biblatex could correctly typeset bibliographic 
information as I could not find the correct methods in the manual and 
...
I found it convinient to OCR all primary sources to simplify the finding of 
...
It is likely that the Google search engine used regularly in the couse of
...
heavily intigrates AI/ML and neural networks in the OS.  Notwithstanding that
which is written here however, I have not knowinlgy used AI/ML tools in the
