...
British preference to expend firepower rather than lives.  
The British Army
...
and organizing those supplies for later use inland.  The BSA had %was it within it?
the docks, the base railway marshalling yard, a main supply depot, a petrol
sub-depot, field bakery, and detailed issue depot.\autocite
[\MaintProj]
[Paras 8, 9]{27course}
...
transported stores from the BSA to the field army.  One peculiarity in 
...
from the BSA.  As the Allies advanced deeper into France, a more formal LofC
...
distribution.  Firstly, tanker lorries in civilian use were not fit for 
